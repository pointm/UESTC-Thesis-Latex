...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\linewidth]{pic/chapter3/输入窗的总体视图.png}
    \caption{脊波导窗的整体结构}
    \label{fig:脊波导窗的整体结构}
\end{figure}

为了方便设计加工与焊接，窗片被设置为圆形窗片。为了减少匹配段的长度，窗片与脊波导之间的过渡部分被设计为倒圆角的矩形过渡段，其中对过渡部分倒圆角是为了降低过渡段的最大场强，提升窗片的功率容量，防止窗片被击穿。各个部分的详细尺寸被记载于图\ref{fig:窗片与脊波导之间过渡段的尺寸}中。其中\ref{fig:纵向长度}展示了窗片的纵向长度，圆角矩形过渡段的纵向长度为1.69mm，窗片的厚度为0.91mm。

\begin{figure}[!htb]
    \small
    \centering
    \begin{tabular}{@{\ }c@{\ }c}
        \includegraphics[width=0.45\textwidth]{pic/chapter3/纵向长度视图.png} & 
        \hspace{5pt}
        \includegraphics[width=0.45\textwidth]{pic/chapter3/圆形窗片视图.png}     \\
        \mbox{\small (a)过渡段纵向长度}                                                                               & 
        \mbox{\small (b)圆形窗片参数}                                                                                  \\
    \end{tabular}
    \\[6bp]
    ...
    \begin{subfigure}[t]{0.65\linewidth}
        \centering
        \includegraphics[scale=0.55]{pic/chapter3/圆角矩形视图.png}
        \caption{Fig. 3}
        \label{fig:圆角矩形过渡段参数}
    \end{subfigure}
    \caption{窗片与圆角矩形过渡段尺寸}
    \label{fig:窗片与脊波导之间过渡段的尺寸}
\end{figure}
