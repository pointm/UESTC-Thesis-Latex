...
当一定时间后，初始被放置在器件中的电子数目没有归零的话，就判定为器件被击穿。结合以上分析与初始设定，此时使用Spark3D初步仿真得到窗片的功率容量为10kW，具体的Spark3d的仿真结果如图\ref{fig:X波段Spark3D中的功率}所示。图中横轴为仿真时间，纵轴为电子总数目。
\begin{figure}[!htb]
    \centering
