...
\begin{figure}[!htb]
    ...
    \begin{tabular}{@{\ }c@{\ }c}
        ...
        \hspace{5pt}
        \includegraphics[width=0.25\textwidth]{pic/chapter3/辐射单元选择.png}     \\
        \mbox{\small (a)对流散热设置}                                                                               & 
        \mbox{\small (b)辐射散热设置}                                                                                  \\
    \end{tabular}
