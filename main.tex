...
\begin{figure}[!htbp]
    ...
    \begin{tabular}{@{}c@{\hspace{5pt}}c@{}}
        \includegraphics[width=0.45\textwidth]{pic/chapter2/HFSS仿真结果.png} & 
        \includegraphics[width=0.45\textwidth]{pic/chapter2/理论计算结果.png} \\
        \mbox{\small (a) HFSS计算的S参数结果} & 
        \mbox{\small (b) 理论计算结果} \\
        \multicolumn{2}{c}{\includegraphics[width=0.35\textwidth]{pic/chapter2/HFSS盒型窗建模.png}} \\  % 使用跨列居中
...
\begin{figure}[!htb]
    ...
    \centering
    \begin{tabular}{@{\ }c@{\ }c}
        \includegraphics[width=0.29\textwidth]{pic/chapter4/L波段窗纵向长度ORI.png} & 
        \hspace{5pt}
        \includegraphics[width=0.29\textwidth]{pic/chapter4/L波段圆形窗片.png}     \\
        \mbox{\small (a)L波段脊波导圆窗纵向长度}                                                                               & 
        \mbox{\small (b)L波段脊波导圆窗参数}                                                           \\[6bp]
        \multicolumn{2}{c}{\includegraphics[width=0.45\textwidth]{pic/chapter4/L波段圆角矩形过渡段ORI.png}} \\  % 使用跨列居中
